...
public class CspParser extends Parser {
	...
	public static class DEFContext extends SimpleDefinitionContext {
		...
		public DEFContext(SimpleDefinitionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CspListener ) ((CspListener)listener).enterDEF(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CspListener ) ((CspListener)listener).exitDEF(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CspVisitor ) return ((CspVisitor<? extends T>)visitor).visitDEF(this);
			else return visitor.visitChildren(this);
		}
	}
